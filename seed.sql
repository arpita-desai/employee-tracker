...
INSERT INTO roles (title, salary, department_id) VALUES ("Lawer", 80000, 4);
INSERT INTO roles (title, salary, department_id) VALUES ("Marketing Manager", 70000, 5);



INSERT INTO employee (first_name, last_name, manager_id, role_id) VALUES ("Ravi","Patel",,5);
INSERT INTO employee (first_name, last_name, manager_id, role_id) VALUES ("William","Adam",1,3);
INSERT INTO employee (first_name, last_name, manager_id, role_id) VALUES ("Tom","Suh",,2);
INSERT INTO employee (first_name, last_name, manager_id, role_id) VALUES ("May","Hume",,1);
INSERT INTO employee (first_name, last_name, manager_id, role_id) VALUES ("Cass","Craven",,4);
INSERT INTO employee (first_name, last_name, manager_id, role_id) VALUES ("Nick","Roy",3,2);
INSERT INTO employee (first_name, last_name, manager_id, role_id) VALUES ("Matt","Benton",,6);
INSERT INTO employee (first_name, last_name, manager_id, role_id) VALUES ("Mika","Marks",7,3);
INSERT INTO employee (first_name, last_name, manager_id, role_id) VALUES ("Ryan","John",,5);
